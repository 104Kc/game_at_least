...
const TEXT: Record<string, string> = {
  ...
  day1_choice1_optA_story:  ['คุณถอนหายใจยาวเฮือกใหญ่',
                             ...
                             'โชคดีจริงๆเลยนะ',
                             '[ได้รับ Hope หนึ่งหน่วย]'],
  day1_choice1_optB_story:  ['คุณตัดสินใจหันหลังกลับ',
                             'ยังไงหน้าที่ของคุณที่นี่ก็จบลงแล้ว',
                             ' สิ่งที่คุณควรทำตอนนี้คือการพักผ่อน',
                             ' .......ใช่มั้ยล่ะ?'
                             '...........',
                             '[ได้รับ Fracture หนึ่งหน่วย]'],
  day1_converge_story:      ['เวลาพลบค่ำในวันนั้น',
  ...
  day1_choice2_optA_story:  ['เมื่อกลับถึงบ้านเมื่อไหร่',
                             'คุณคิดว่าอยากจะลองดูสักหน่อยกับไอเดียนี้',
                             '[ได้รับ Hope หนึ่งหน่วย]'],
  day1_choice2_optB_story:  ['ดูเหมือนว่าคุณจะมีเรื่องอื่นที่ต้องใส่ใจมากกว่าในตอนนี้',
